# tweet_rate_gen_py33.py   Tested with Python 3.3
...
from tweet_rate_oauth_py33 import oauth
...
class IndexHandler(tornado.web.RequestHandler):
	...
	def get(self):
		...
		response = yield tornado.gen.Task(client.fetch, url, headers=oauth(url))
